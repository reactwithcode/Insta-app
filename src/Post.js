...
function Post({lang, postId, username, user, caption, imageUrl, imagename, viewwhichuser}) {
    ...
    return (
        <div className="post">
            <div className="post__header" style={{padding: '20px'}}>
                <Avatar 
                ...
                {user && ( // Only display this comment form input if the user has logged in
                    <form className="post__commentBox">
                        <Textarea
                            ...
                            type="text"
                            placeholder={lang ? "Add a comment":"Tambahkan komentar"}
                            value={comment}
